...
ActiveRecord::Schema[7.1].define(version: 2026_03_06_082845) do
  ...
  create_table "growth_records", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recorded_on"], name: "index_growth_records_on_recorded_on", unique: true
  end

  create_table "health_tips", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title"
    t.text "content"
    t.string "category"
    t.string "source_url"
